		...
		<div class="fade-in-box">
			<form action="complete" method="post">
				<table class="type10">
					<tr>
						<td>예약일 :</td>
						<td><input type="date" name="bookingDate" value="${revDate}"
							readonly="readonly" id="date"></td>
					</tr>
					<tr>
						<td>예약시간 :</td>
						<td><input type="text" name="bookingTime" value="${revTime}"
							readonly="readonly" id="time"></td>
					</tr>
					<tr>
						<td>예약자명 :</td>
					...
					<tr>
						<td>예약 인원 :</td>
						<td><input type="number" name="cnt" id="cnt" min="1"
							max="${10-cnt}" required="required"></td>
					</tr>
					<tr>
						<td>요청 사항 :</td>
				...
				<button type="button" class="btn btn-primary btn-sm"
					data-toggle="modal" data-target="#Modal" id="submit">예약하기</button>
				<!-- Modal -->
                            ...
                            modal body -->
								...
								<p>
									...
									<input type="submit" class="btn btn-success btn-sm"
										data-toggle="modal" data-target="#Modal" id="submit" value="완료">
							</div>
						</div>
					</div>
				</div>
